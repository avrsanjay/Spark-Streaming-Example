...
object testplay2 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(63); 
val r = new Random();System.out.println("""r  : java.util.Random = """ + $show(r ));$skip(13); val res$0 = 
r.nextInt(4);System.out.println("""res0: Int = """ + $show(res$0))}
